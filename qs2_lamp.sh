...
echo mysql-server-5.5 mysql-server/root_password        password ${QS_PASS} | sudo debconf-set-selections
echo mysql-server-5.5 mysql-server/root_password_again  password ${QS_PASS} | sudo debconf-set-selections
...
echo phpmyadmin       phpmyadmin/app-password-confirm   password ${QS_PASS} | sudo debconf-set-selections
